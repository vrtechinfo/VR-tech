...
export default function WhyChooseUs(): JSX.Element {
    return (
        <div className="bg-[url(/chooseus.png)] min-h-[600px] sm:min-h-[800px] md:min-h-[1000px] lg:min-h-[1288px] w-full bg-cover bg-center text-white">
            ...
            <div className="flex justify-center pt-5 ml-0 sm:ml-[200px] md:ml-[400px] lg:ml-[600px] px-4 sm:px-0">
                <div className="text-lg sm:text-xl md:text-2xl font-light">
                    ...
                    <div className="flex items-center pl-4 sm:pl-8 md:pl-12 lg:pl-20 pt-6 sm:pt-10 md:pt-15 lg:pt-20 gap-4 sm:gap-6 md:gap-8 lg:gap-10">
                        <ChooseIcon />
                        <div>Hands-On Projects and Real-World Scenarios</div>
                    </div>
                    <div className="flex items-center pl-8 sm:pl-16 md:pl-24 lg:pl-40 pt-6 sm:pt-10 md:pt-15 lg:pt-20 gap-4 sm:gap-6 md:gap-8 lg:gap-10">
                        <ChooseIcon />
                        <div>Access to Cutting-Edge Tools and Technologies</div>
                    </div>
                    <div className="flex items-center pl-10 sm:pl-20 md:pl-30 lg:pl-50 pt-6 sm:pt-10 md:pt-15 lg:pt-20 gap-4 sm:gap-6 md:gap-8 lg:gap-10">
                        <ChooseIcon />
