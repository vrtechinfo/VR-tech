...
export default function WhyChooseUs(): JSX.Element {
    return (
        <div className="bg-[url(/chooseus.png)] min-h-[700px] sm:min-h-[800px] md:min-h-[1000px] lg:min-h-[1288px] w-full overflow-hidden bg-cover bg-right sm:bg-right-top md:bg-center text-white">
