...
export default function Features(): JSX.Element {
    return (
        <div className="bg-[url(/features-bg.png)] min-h-[400px] sm:min-h-[500px] md:min-h-[600px] lg:min-h-[691px] w-full bg-cover bg-center text-white py-8 sm:py-12 md:py-16">
