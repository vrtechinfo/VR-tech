...
// @ts-ignore - three/webgpu lacks type definitions
...
export const FuturisticHero = () => {
    ...
    const subtitle = ' With VR-TECH INFO.';
    ...
    useEffect(() => {
        // Client only: generate random delays for glitch
    ...
    return (
        <div className="h-full w-full relative">
            ...
            <Canvas
                ...
                flat
                dpr={[1, 2]} // Performance optimization: allow high DPI but cap at 2x
                gl={async (props) => {
